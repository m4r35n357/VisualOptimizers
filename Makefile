...
test-16d: nogl
	...
	@./whale-ackley-std 3 0 16 500 500 1 -20 20 >/dev/null
	@echo ""
	@./nm-rosenbrock-std 3 0 16 1.0e-6 1000000 1.0 1 50 -20 20 >/dev/null
	@./spiral-rosenbrock-std 3 0 16 500 500 0 1 -20 20 >/dev/null
	@./spiral-rosenbrock-std 3 0 16 500 500 1 1 -20 20 >/dev/null
	@./whale-rosenbrock-std 3 0 16 500 500 1 -20 20 >/dev/null
	@echo ""
	@./nm-st-std 3 0 16 1.0e-6 1000000 10.0 1 50 -20 20 >/dev/null
	@./spiral-st-std 3 0 16 500 500 0 1 -20 20 >/dev/null
	@./spiral-st-std 3 0 16 500 500 1 1 -20 20 >/dev/null
	@./whale-st-std 3 0 16 500 500 1 -20 20 >/dev/null
	@echo ""
	...
	@./whale-dixon-price-std 3 0 16 500 500 1 -5 5 >/dev/null
	@echo ""
	@./nm-levy-std 3 0 16 1.0e-6 1000000 10.0 1 50 -20 20 >/dev/null
	@./spiral-levy-std 3 0 16 500 500 0 1 -20 20 >/dev/null
	@./spiral-levy-std 3 0 16 500 500 1 1 -20 20 >/dev/null
	@./whale-levy-std 3 0 16 500 500 1 -20 20 >/dev/null
	@echo ""
	@./nm-sqrt-std 3 0 16 1.0e-6 1000000 5.0 1 50 -20 20 >/dev/null
	@./spiral-sqrt-std 3 0 16 500 500 0 1 -20 20 >/dev/null
	@./spiral-sqrt-std 3 0 16 500 500 1 1 -20 20 >/dev/null
	@./whale-sqrt-std 3 0 16 500 500 1 -20 20 >/dev/null
	@echo ""
	@./nm-michalewicz-std 3 0 16 1.0e-6 1000000 1.0 1 50 -3.14 3.14 >/dev/null
	...
	@./whale-easom-std 3 0 16 500 500 1 -25 25 >/dev/null
	@echo ""
...
test-8d: nogl
	...
	@echo ""
	@./nm-ackley-std 3 0 8 1.0e-6 100000 5.0 1 20 -10 10 >/dev/null
	...
	@echo ""
	@./nm-rosenbrock-std 3 0 8 1.0e-6 100000 1.0 1 20 -10 10 >/dev/null
	@./spiral-rosenbrock-std 3 0 8 200 500 0 1 -10 10 >/dev/null
	@./spiral-rosenbrock-std 3 0 8 200 500 1 1 -10 10 >/dev/null
	@./whale-rosenbrock-std 3 0 8 200 500 1 -10 10 >/dev/null
	@echo ""
	@./nm-st-std 3 0 8 1.0e-6 100000 10.0 1 20 -10 10 >/dev/null
	@./spiral-st-std 3 0 8 200 500 0 1 -10 10 >/dev/null
	@./spiral-st-std 3 0 8 200 500 1 1 -10 10 >/dev/null
	@./whale-st-std 3 0 8 200 500 1 -10 10 >/dev/null
	@echo ""
	@./nm-dixon-price-std 3 0 8 1.0e-6 100000 1.0 1 20 -5 5 >/dev/null
	@./spiral-dixon-price-std 3 0 8 200 500 0 1 -5 5 >/dev/null
	@./spiral-dixon-price-std 3 0 8 200 500 1 1 -5 5 >/dev/null
	@./whale-dixon-price-std 3 0 8 200 500 1 -5 5 >/dev/null
	@echo ""
	...
	@echo ""
	@./nm-michalewicz-std 3 0 8 1.0e-6 100000 1.0 1 20 -3.14 3.14 >/dev/null
	@./spiral-michalewicz-std 3 0 8 200 500 0 1 -3.14 3.14 >/dev/null
	@./spiral-michalewicz-std 3 0 8 200 500 1 1 -3.14 3.14 >/dev/null
	@./whale-michalewicz-std 3 0 8 200 500 1 -3.14 3.14 >/dev/null
	@echo ""
	@./nm-easom-std 3 0 8 1.0e-6 100000 1.0 1 20 -15 15 >/dev/null
	@./spiral-easom-std 3 0 8 200 500 0 1 -15 15 >/dev/null
	@./spiral-easom-std 3 0 8 200 500 1 1 -15 15 >/dev/null
	@./whale-easom-std 3 0 8 200 500 1 -15 15 >/dev/null
	@echo ""
...
test-3d: nogl
	...
	@./whale-dixon-price-std 3 0 3 30 100 0 -5 5 >/dev/null
	@echo ""
	...
	@./whale-rastrigin-std 3 0 3 30 100 0 -5 5 >/dev/null
	@echo ""
	...
	@./whale-easom-std 3 0 3 30 100 0 -10 10 >/dev/null
	@echo ""
