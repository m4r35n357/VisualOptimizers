...
test-6d: all
	@./run.sh -b nm-hartmann6-std -v 0 -p 0.5,0.5,0.5,0.5,0.5,0.5
	@./run.sh -b nm-sphere-std -v 0 -p 1.0,1.0,1.0,-2.10,-3.04,4.50

test-4d: all
	@./run.sh -b nm-ackley-std -v 0 -p 3.0,-2.10,-3.04,4.50 
	@./run.sh -b nm-sphere-std -v 0 -p 1.0,-2.10,-3.04,4.50
	@./run.sh -b nm-dixon-price-std -v 0 -p 1.0,1.0,1.0,1.0

test-3d: all
	@./run.sh -b nm-ackley-std -v 0 -p -2.10,-3.04,4.50 
	@./run.sh -b nm-sphere-std -v 0 -p -2.10,-3.04,4.50
	@./run.sh -b nm-st-std -v 0 -p 0.0,0.0,0.0
	@./run.sh -b nm-hartmann3-std -v 0 -p 0.5,0.5,0.5
	@./run.sh -b nm-dixon-price-std -v 0 -p 1.0,1.0,1.0
	@./run.sh -b nm-rosenbrock-std -v 0 -p 1.0,0.0,-1.0
	@./run.sh -b nm-rastrigin-std -v 0 -p 0.0,0.0,0.0

test-2d: all
	@./run.sh -b nm-rosenbrock-std -v 0 -p 1.0,0.0
	@./run.sh -b nm-himmelblau-std -v 0 -p 3.0,3.0
	@./run.sh -b nm-himmelblau-std -v 0 -p 3.0,-3.0
	@./run.sh -b nm-himmelblau-std -v 0 -p -3.0,3.0
	@./run.sh -b nm-himmelblau-std -v 0 -p -3.0,-3.0
