...
test-8d: nogl
	...
	@./cut-st-std 3 0 8 6561 100 -10 10 >/dev/null
	@echo ""
	...
	@./cut-dixon-price-std 3 0 8 6561 100 -5 5 >/dev/null
	@echo ""
	...
	@./cut-levy-std 3 0 8 6561 100 -10 10 >/dev/null
	@echo ""
...
test-3d: nogl
	...
	@./cut-st-std 3 0 3 64 100 -5 5 >/dev/null
	@echo ""
	...
	@./cut-dixon-price-std 3 0 3 64 100 -5 5 >/dev/null
	@echo ""
	...
	@./cut-levy-std 3 0 3 64 100 -10 10 >/dev/null
	@echo ""
	...
	@./cut-rastrigin-std 3 0 3 64 100 -5 5 >/dev/null
	@echo ""
	...
	@./cut-schwefel-std 3 0 3 64 100 -500.0 500.0 >/dev/null
	@echo ""
